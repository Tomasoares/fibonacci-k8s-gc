...
kubectl set image deployments/worker-deployment server=tomasoares/fibonacci-worker:$SHA
kubectl set image deployments/server-deployment server=tomasoares/fibonacci-server:$SHA
kubectl set image deployments/client-deployment server=tomasoares/fibonacci-client:$SHA